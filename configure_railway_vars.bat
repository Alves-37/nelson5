...
railway variables set DATABASE_PUBLIC_URL="postgresql://postgres:eGToQQQrasBZetMsloLDrKdPMvtYctNv@centerbeam.proxy.rlwy.net:10079/railway"

echo 2. Configurando DATABASE_URL...
railway variables set DATABASE_URL="postgresql://postgres:eGToQQQrasBZetMsloLDrKdPMvtYctNv@postgres.railway.internal:5432/railway"
